...
export class EmailService {
  ...
  public wrapInBrandedTemplate(title: string, content: string): string {
    // If content is already HTML (rich text), use it directly.
    // Otherwise convert plain newlines to <br />.
...
<body style="margin:0;padding:0;background-color:#ffffff;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#ffffff;">
    <tr>
      <td style="padding:32px 24px 0 24px;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.75;color:#344054;">

        <!-- Content — font/size overrides from the editor are preserved -->
